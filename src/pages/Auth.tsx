...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-background via-muted to-background p-12 items-center justify-center">
        <div className="relative z-10 text-center space-y-8">
          <div className="mx-auto w-24 h-24 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center ring-4 ring-background shadow-2xl">
          ...
          <div className="space-y-4 max-w-lg">
            ...
            <p className="text-lg text-muted-foreground">
              Join our vibrant temple community and embark on a journey of spiritual growth, 
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 relative">
        <Card className="w-full max-w-md relative backdrop-blur-sm bg-background/80">
          <CardHeader className="text-center space-y-4">
            <div className="lg:hidden mx-auto w-16 h-16 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center">
